...
import com.example.miband3.com.luigidarco.mibandconnector.listeners.HeartRateNotifyListener;
import com.example.miband3.com.luigidarco.mibandconnector.listeners.NotifyListener;
import com.example.miband3.com.luigidarco.mibandconnector.listeners.RealtimeStepsNotifyListener;
import com.example.miband3.com.luigidarco.mibandconnector.modules.BatteryInfo;
import com.example.miband3.com.luigidarco.mibandconnector.modules.Profile;
import com.example.miband3.com.luigidarco.mibandconnector.modules.Protocol;
import com.example.miband3.com.luigidarco.mibandconnector.modules.StepsInfo;
...
public class MiBand extends Service {
    ...
    public void setRealtimeStepsNotifyListener(final RealtimeStepsNotifyListener listener) {
        this.io.setNotifyListener(Profile.UUID_SERVICE_BAND_1, Profile.UUID_CHAR_STEPS, new NotifyListener() {
            ...
            @Override
            public void onNotify(byte[] data) {
                Log.d(TAG, "Received raw steps data: " + Arrays.toString(data));

                int steps = StepsInfo.getSteps(data);
                int meters = StepsInfo.getMeters(data);
                int calories = StepsInfo.getCalories(data);

                Log.d(TAG, "Parsed steps data: steps=" + steps + ", meters=" + meters + ", calories=" + calories);
                ...
                if (steps != -1) {
                    ...
                    Log.e(TAG, "Failed to parse steps data.");
                }
            }
        });
    }
